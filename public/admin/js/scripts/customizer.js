...
(function (window, document, $) {
  ...
  var themeColor = {
    "theme-primary": "linear-gradient(118deg, #cb292f , rgba(203, 41, 47, 0.7))",
  ...
  var themeBoxShadow = {
    "theme-primary": "0 0 10px 1px rgba(203, 41, 47, 0.7)",
    ...
    $(window).scroll(function(){
      if(body.hasClass('navbar-static')){
        ...
        if (scroll > 65) {
          ...
          $(".horizontal-menu .header-navbar.navbar-fixed").css({"background":"#636363", "box-shadow":"none"});
          $(".horizontal-menu .horizontal-menu-wrapper.header-navbar").css("background" , "#fff");
        }
      }
    })
