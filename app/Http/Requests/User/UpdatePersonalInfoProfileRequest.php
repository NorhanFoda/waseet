...
class UpdatePersonalInfoProfileRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'phone_main' => 'required_if:role_id,2|required_if:role_id,3|required_if:role_id,4|required_if:role_id,5|required_if:role_id,6|min:9|unique:users,phone_main,'.auth()->user()->id,
