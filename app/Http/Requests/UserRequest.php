...
class UserRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'phone_main' => 'required_if:role_id,2|required_if:role_id,3|required_if:role_id,4|required_if:role_id,5|required_if:role_id,6|min:9|max:11|unique:users',
            'phone_main' => 'sometimes|min:9|max:11',
