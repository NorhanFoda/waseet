                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="table-responsive">
                            <a href="{{route('direct_teachers.create')}}" class="btn btn-primary btn-block my-2 waves-effect waves-light">{{trans('admin.add')}} </a>
                                    ...
                                    @foreach($teachers as $teacher)
                                        @if(!$teacher->hasRole('admin'))
                                            ...
                                            <tr align="center">
                                                ...
                                                <td>
                                                    <a href="@if($teacher->receipt != null && $teacher->receipt->image != null) {{$teacher->receipt->image->path}} @else {{route('pay_for_register', ['user_id' => $teacher->id, 'type' => 'direct_teacher'])}} @endif">{{trans('admin.view_receipt')}}</a>
                                                </td>
                                                <td>
