                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="tel" class="form-control" value="{{$seeker->phone_main}}" placeholder="{{trans('admin.phone_main')}}" name="phone_main" required>
                                            <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="tel" class="form-control" value="{{$seeker->phone_secondary}}" placeholder="{{trans('admin.phone_secondary')}}" name="phone_secondary">
                                            <div class="invalid-feedback">
