    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-horizontal needs-validation" enctype="multipart/form-data" novalidate method="post" action="{{route('socials.update', $social->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="url" class="form-control" value="{{$social->link}}" placeholder="{{trans('admin.link')}}" name="link" required>
                                ...
                                <div class="col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="checkbox" class="form-control" @if($social->appear_in_footer == 1) checked @endif name="appear_in_footer">
                                            <div class="invalid-feedback">
