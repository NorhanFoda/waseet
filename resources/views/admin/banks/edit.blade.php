    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-horizontal needs-validation" enctype="multipart/form-data" novalidate method="post" action="{{route('banks.update', $bank->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" placeholder="{{trans('admin.name_ar')}}" value="{{$bank->name_ar}}" name="name_ar" required>
                                ...
                                <div class="col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" placeholder="{{trans('admin.name_en')}}" value="{{$bank->name_en}}" name="name_en" required>
                                            <div class="invalid-feedback">
                                                {{trans('admin.name_required')}}
                                            </div>
                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" value="{{$bank->account_number}}" placeholder="{{trans('admin.account_number')}}" name="account_number" required>
                                            <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" value="{{$bank->iban}}" placeholder="{{trans('admin.iban')}}" name="iban" required>
                                            <div class="invalid-feedback">
                                                {{trans('admin.iban')}}
                                            </div>
                                        </div>
