    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-horizontal needs-validation" enctype="multipart/form-data" novalidate method="post" action="{{route('sliders.store')}}">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                {{-- enter arabic title --}}
                                <div class="col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" placeholder="{{trans('admin.title_ar')}}" name="title_ar" required>
                                ...
                                <div class="col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" placeholder="{{trans('admin.title_en')}}" name="title_en" required>
                                            <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea name="body_ar" cols="30" rows="6" placeholder="{{trans('admin.body_ar')}}" class="form-control" required></textarea>
                                            <div class="invalid-feedback">
                                                {{trans('admin.body_ar')}}
                                            </div>
                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea name="body_en" cols="30" rows="6" placeholder="{{trans('admin.body_en')}}" class="form-control" required></textarea>
                                            <div class="invalid-feedback">
                                                {{trans('admin.body_en')}}
                                            </div>
                                        </div>
                                ...
                                {{-- enter english body end --}}
                                 ...
                                 <div class="col-12">
                                    <div class="form-group row">
                                        <div class="col-md-2">
                                            <span>{{trans('admin.image')}} ({{trans('admin.h_w')}} : 480 * 1920‎)</span>
                                        </div>
                                        <div class="col-md-10">
