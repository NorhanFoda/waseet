                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="table-responsive">
                            <a href="{{route('specializations.create')}}" class="btn btn-primary btn-block my-2 waves-effect waves-light">{{trans('admin.add')}} </a>
                                ...
                                <tbody>
                                    @foreach($specializations as $spc)
                                        <tr align="center">
                                            ...
                                            <td>{{$spc->name_en}}</td>
                                            <td>
                                                <a href="{{route('specializations.show', $spc->id)}}" class="btn" style="color:white;"><i class="fa fa-eye"></i></a>
                                                @if($spc->id != 3)
                                                    <a href="{{route('specializations.edit', $spc->id)}}" class="btn" style="color:white;"><i class="fa fa-pencil-square-o"></i></a>
