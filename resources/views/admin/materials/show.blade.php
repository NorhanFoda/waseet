        ...
        <div class="col-12">
            ...
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{trans('admin.materials')}}
                    </li>
                </ol>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">
                            {{$material->{'name_'.session('lang')} }}
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            @if($material->id != 4)
                                <a href="{{route('materials.edit', $material->id)}}" class="btn btn-primary mr-1"><i class="feather icon-edit-1"></i>{{trans('admin.edit')}}</a>
                    ...
                    <div class="card-body px-75">
                        <div class="table-responsive users-view-permission">
                            <table class="table table-borderless dt-responsive nowrap" id="data_table">
                                ...
                                <tbody>
                                    @foreach($material->stages as $stage)
                                        <tr>
                                            <td>{{$loop->iteration}}</td>
                                            <td>{{$stage->{'name_'.session('lang')} }}</td>
                                            <td>
