...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto"><a class="navbar-brand" target="_blank" href="{{route('admin.home')}}">
                    <div class="brand-logo"><img src="{{asset(('/images/logo2.png'))}}" alt="logo"/></div>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="{{route('admin.home')}}"><i class="fa fa-home"></i><span class="menu-title" data-i18n="Dashboard">{{trans('admin.home')}}</span></a></li>
