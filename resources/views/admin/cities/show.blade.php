                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">
                            {{$city->{'name_'.session('lang')} }}
                        </div>
                        <div class="card-title">
                            {{$city->country->{'name_'.session('lang')} }}
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <a href="{{route('cities.edit', $city->id)}}" class="btn btn-primary mr-1"><i class="feather icon-edit-1"></i>{{trans('admin.edit')}}</a>
