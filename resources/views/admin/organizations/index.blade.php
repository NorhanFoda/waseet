                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="table-responsive">
                            <a href="{{route('bags.create')}}" class="btn btn-primary btn-block my-2 waves-effect waves-light">{{trans('admin.add')}} </a>
                                ...
                                <tbody>
                                    @foreach($bags as $bag)
                                        <tr align="center">
                                            ...
                                            <td>{{$bag->name_ar}}</td>
                                            <td>{{$bag->name_en}}</td>
                                            <td>{{$bag->price}} {{trans('admin.sr')}}</td>
                                            <td>
                                                <a href="{{route('bags.show', $bag->id)}}" class="btn" style="color:white;"><i class="fa fa-eye"></i></a>
                                                <a href="{{route('bags.edit', $bag->id)}}" class="btn" style="color:white;"><i class="fa fa-pencil-square-o"></i></a>
