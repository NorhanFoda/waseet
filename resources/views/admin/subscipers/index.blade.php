            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{trans('admin.subscripers')}}
                        </li>
                    </ol>
                </div>
            </div>
                                ...
                                <tbody>
                                    @foreach($subs as $sub)
                                        <tr align="center">
                                            ...
                                            <td>{{$sub->email}}</td>
                                            <td>
                                                <a title="delete" onclick="return true;" id="confirm-color" object_id='{{$sub->id}}'
