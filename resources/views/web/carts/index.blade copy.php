                                ...
                                <li class="gray-bg" data-aos="fade-up">
                                    <div class="packsWrap book-details">
                                        ...
                                        <div class="pack-width">
                                            ...
                                            <a href="#" data-buy_type="2" data-user_id="{{$cart->user_id}}" data-bag_id="{{$cart->bag_id}}" class="custom-btn edit_cart"><i class="fa fa-undo"></i>{{trans('web.print_content')}}</a>
                                            <a href="#" data-buy_type="1" data-user_id="{{$cart->user_id}}" data-bag_id="{{$cart->bag_id}}" class="custom-btn edit_cart"><i class="fa fa-cart-plus"></i>{{trans('web.buy_online')}}</a>
