                        ...
                        <form action="{{route('jobs.update_seeker')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="inputs-contain">
                                ...
                                <div class="userName">
                                    ...
                                    <input type="tel" class="active phone-input-style" name="phone_main" value="{{$phone_main}}" minlength="9" maxlength="11" required />
                                ...
                                <div class="userName">
                                    ...
                                    <input type="tel" class="active phone-input-style" name="phone_secondary" value="{{$phone_secondary}}" minlength="9" maxlength="11" />
